...
var data_a = new Uint8Array(Uint8Array.from("Gujarat\nUttar Pradesh\nKolkata\nBihar\nJammu and Kashmir", x => x.charCodeAt(0)));
var data_b = new Uint8Array(Uint8Array.from("Tamil Nadu\nGujarat\nAndhra Pradesh\nBihar\nUttar pradesh", x => x.charCodeAt(0)));

FS.createDataFile('/', 'a.txt', data_a, true, true, true);
FS.createDataFile('/', 'b.txt', data_b, true, true, true);
